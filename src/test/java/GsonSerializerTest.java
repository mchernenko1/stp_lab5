...
public class GsonSerializerTest {
    ...
    public  void init(){NestedObject nestedObj;
        ser = new GSONserializer<>(SerializableObject.class);
    ...
    @Test
    public void GsonTest() throws IOException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
